...
// (choosing-a-form.md): a bare number is a stat tile, a groupby result
// is a bar chart (the only "compare magnitude across categories" shape
// this project produces), a whole column is a table (row-level data has
// no natural chart form of its own). Shared by the ad-hoc query results
// area and every dashboard tile - same result shapes, same rendering.
